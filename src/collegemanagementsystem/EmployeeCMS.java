...
public class EmployeeCMS extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeCMS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
