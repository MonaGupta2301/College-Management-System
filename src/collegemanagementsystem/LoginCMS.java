...
public class LoginCMS extends javax.swing.JFrame {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jPasswordField1, javax.swing.GroupLayout.DEFAULT_SIZE, 405, Short.MAX_VALUE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(119, 119, 119)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      {                    
             ...
             r.next();
             if(r.getString("Admin_Name").equals(jTextField1.getText()) && r.getString("Password").equals(jPasswordField1.getText()))
             {
                  JOptionPane.showMessageDialog(this,"Login Successfully","Information",JOptionPane.INFORMATION_MESSAGE);
                  AdminCMS admin= new AdminCMS();
                  admin.show();
                  dispose();
             }
             else
             {
                  JOptionPane.showMessageDialog(this,"Incorrect User name and Password","Warning",JOptionPane.WARNING_MESSAGE);                  
             }
          }
      catch(Exception e)
      {
