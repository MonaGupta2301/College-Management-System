    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
          ...
          else
          {
                   try
                   {
                            ...
                            String sql="insert into student(First_Name,Last_Name,Class,Year,DOB,Contact,Email_Id,Gender,Permanant_Address,Percentage) values(' "+First_Name+" ', ' "+Last_Name+" ',' "+Class+" ',' "+Year+" ',' "+DOB+" ',' "+Contact+" ',' "+Email_Id+" ',' "+Gender+" ',' "+Permanant_Address+" ',' "+Percentage+" ' )";
