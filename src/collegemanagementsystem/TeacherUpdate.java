...
public class TeacherUpdate extends javax.swing.JFrame {
  ...
  public void Connect()
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            String sql=" select  First_Name,Last_Name,Position,Age,Contact,Email,Gender,Permanant_Address,Present_Address from teacher where id= "+Id+" ";
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try
        {
            String sql="update teacher set First_Name=' "+First_Name+" ', Last_Name=' "+Last_Name+" ' , Position=' "+Position+" ' ,Age=' "+Age+" ',Contact=' "+Contact+" ',Email=' "+Email+" ',Gender=' "+Gender+" ',Permanant_Address=' "+Permanant_Address+" ' ,Present_Address=' "+Present_Address+" '  where id="+Id+" ";
